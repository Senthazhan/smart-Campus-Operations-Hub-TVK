...
\- Senthazhan: Authentication, role management, notifications, profile management, OAuth2 integration

\- Bavatharani: Facilities catalogue and resource management

\- Kabilan: Booking workflow and conflict checking

\- Ajaniya: Incident tickets and technician updates

## 📜 Documentation

* **Technical Blueprint**: [PROJECT\_BLUEPRINT.md](file:///c:/Users/hp/Desktop/PAF/smart-campus-operations-hub/docs/PROJECT_BLUEPRINT.md)
